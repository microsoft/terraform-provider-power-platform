...
func (client *Client) Execute(ctx context.Context, scopes []string, method, url string, headers http.Header, body any, acceptableStatusCodes []int, responseObj any) (*Response, error) {
	return client.execute(ctx, scopes, method, url, headers, body, acceptableStatusCodes, responseObj, true)
}
...
func (client *Client) ExecuteWithoutRetry(ctx context.Context, scopes []string, method, url string, headers http.Header, body any, acceptableStatusCodes []int, responseObj any) (*Response, error) {
	return client.execute(ctx, scopes, method, url, headers, body, acceptableStatusCodes, responseObj, false)
}

func (client *Client) execute(ctx context.Context, scopes []string, method, url string, headers http.Header, body any, acceptableStatusCodes []int, responseObj any, retry bool) (*Response, error) {
	if len(scopes) == 0 {
