		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestMatchResourceAttr("data.powerplatform_environments.all", "environments.0.dataverse.domain", regexp.MustCompile(powerplatform_helpers.StringRegex)),
					...
					resource.TestMatchResourceAttr("data.powerplatform_environments.all", "environments.0.dataverse.organization_id", regexp.MustCompile(powerplatform_helpers.GuidRegex)),
					resource.TestMatchResourceAttr("data.powerplatform_environments.all", "environments.0.dataverse.security_group_id", regexp.MustCompile(powerplatform_helpers.GuidOrEmptyValueRegex)),
					resource.TestMatchResourceAttr("data.powerplatform_environments.all", "environments.0.dataverse.url", regexp.MustCompile(powerplatform_helpers.UrlValidStringRegex)),
					...
					resource.TestMatchResourceAttr("data.powerplatform_environments.all", "environments.0.dataverse.version", regexp.MustCompile(powerplatform_helpers.VersionRegex)),
					resource.TestMatchResourceAttr("data.powerplatform_environments.all", "environments.0.dataverse.currency_code", regexp.MustCompile(powerplatform_helpers.StringRegex)),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.powerplatform_environments.all", "environments.1.display_name", "Admin AdminOnMicrosoft's Environment"),
					resource.TestCheckResourceAttr("data.powerplatform_environments.all", "environments.1.dataverse.domain", "00000000-0000-0000-0000-000000000001"),
					resource.TestCheckResourceAttr("data.powerplatform_environments.all", "environments.1.id", "00000000-0000-0000-0000-000000000001"),
					resource.TestCheckResourceAttr("data.powerplatform_environments.all", "environments.1.environment_type", "Developer"),
					resource.TestCheckResourceAttr("data.powerplatform_environments.all", "environments.1.dataverse.language_code", "1033"),
					resource.TestCheckResourceAttr("data.powerplatform_environments.all", "environments.1.dataverse.organization_id", "6450637c-f9a8-4988-8cf7-b03723d51ab7"),
					resource.TestCheckResourceAttr("data.powerplatform_environments.all", "environments.1.dataverse.security_group_id", ""),
					resource.TestCheckResourceAttr("data.powerplatform_environments.all", "environments.1.dataverse.url", "https://00000000-0000-0000-0000-000000000001.crm4.dynamics.com/"),
					resource.TestCheckResourceAttr("data.powerplatform_environments.all", "environments.1.location", "europe"),
					resource.TestCheckResourceAttr("data.powerplatform_environments.all", "environments.1.dataverse.version", "9.2.23092.00206"),
					//resource.TestCheckResourceAttr("data.powerplatform_environments.all", "environments.1.dataverse.linked_app_type", ""),
					//resource.TestCheckResourceAttr("data.powerplatform_environments.all", "environments.1.dataverse.linked_app_id", ""),
					//resource.TestCheckResourceAttr("data.powerplatform_environments.all", "environments.1.dataverse.linked_app_url", ""),
					resource.TestCheckResourceAttr("data.powerplatform_environments.all", "environments.1.dataverse.currency_code", "PLN"),
					resource.TestCheckResourceAttr("data.powerplatform_environments.all", "environments.1.billing_policy_id", "00000000-0000-0000-0000-000000000001"),
				),
			},
		},
	})
