		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("powerplatform_environment_settings.settings", "is_audit_enabled", "true"),
					resource.TestCheckResourceAttr("powerplatform_environment_settings.settings", "is_read_audit_enabled", "true"),
					resource.TestCheckResourceAttr("powerplatform_environment_settings.settings", "is_user_access_audit_enabled", "true"),
					resource.TestCheckResourceAttr("powerplatform_environment_settings.settings", "max_upload_file_size_in_bytes", "100"),
					resource.TestCheckResourceAttr("powerplatform_environment_settings.settings", "plugin_trace_log_setting", "All"),
					resource.TestCheckResourceAttr("powerplatform_environment_settings.settings", "show_dashboard_cards_in_expanded_state", "true"),
				),
			},
		},
	})
