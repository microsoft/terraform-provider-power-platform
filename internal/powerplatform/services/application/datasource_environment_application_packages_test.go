		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestMatchResourceAttr("data.powerplatform_environment_application_packages.all_applications", "environment_id", regexp.MustCompile(helpers.GuidRegex)),
					...
					resource.TestMatchResourceAttr("data.powerplatform_environment_application_packages.all_applications", "applications.0.application_id", regexp.MustCompile(helpers.GuidRegex)),
					resource.TestMatchResourceAttr("data.powerplatform_environment_application_packages.all_applications", "applications.0.application_name", regexp.MustCompile(helpers.StringRegex)),
					resource.TestMatchResourceAttr("data.powerplatform_environment_application_packages.all_applications", "applications.0.unique_name", regexp.MustCompile(helpers.StringRegex)),
					resource.TestMatchResourceAttr("data.powerplatform_environment_application_packages.all_applications", "applications.0.version", regexp.MustCompile(helpers.StringRegex)),
					resource.TestMatchResourceAttr("data.powerplatform_environment_application_packages.all_applications", "applications.0.description", regexp.MustCompile(helpers.StringRegex)),
					resource.TestMatchResourceAttr("data.powerplatform_environment_application_packages.all_applications", "applications.0.publisher_id", regexp.MustCompile(helpers.GuidRegex)),
					resource.TestMatchResourceAttr("data.powerplatform_environment_application_packages.all_applications", "applications.0.publisher_name", regexp.MustCompile(helpers.StringRegex)),
					resource.TestMatchResourceAttr("data.powerplatform_environment_application_packages.all_applications", "applications.0.learn_more_url", regexp.MustCompile(helpers.UrlValidStringRegex)),
					resource.TestMatchResourceAttr("data.powerplatform_environment_application_packages.all_applications", "applications.0.state", regexp.MustCompile(helpers.StringRegex)),
					resource.TestMatchResourceAttr("data.powerplatform_environment_application_packages.all_applications", "applications.0.application_visibility", regexp.MustCompile(helpers.StringRegex)),
				),
			},
		},
	})
...
func TestUnitEnvironmentApplicationPackagesDataSource_Validate_Read(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", "https://europe.api.bap.microsoft.com/providers/Microsoft.BusinessAppPlatform/lifecycleOperations/00000000-0000-0000-0000-000000000001?api-version=2023-06-01",
		func(req *http.Request) (*http.Response, error) {
			return httpmock.NewStringResponse(http.StatusOK, httpmock.File("tests/datasource/environment_application_packages/Validate_Read/get_lifecycle_delete.json").String()), nil
		})
	...
	httpmock.RegisterResponder("GET", "https://europe.api.bap.microsoft.com/providers/Microsoft.BusinessAppPlatform/lifecycleOperations/b03e1e6d-73db-4367-90e1-2e378bf7e2fc?api-version=2023-06-01",
		func(req *http.Request) (*http.Response, error) {
			return httpmock.NewStringResponse(http.StatusOK, httpmock.File("tests/datasource/environment_application_packages/Validate_Read/get_lifecycle.json").String()), nil
		})
...
func TestUnitEnvironmentApplicationPackagesDataSource_Validate_No_Dataverse(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
	...
	httpmock.RegisterResponder("GET", `https://api.powerplatform.com/appmanagement/environments/00000000-0000-0000-0000-000000000001/applicationPackages?api-version=2022-03-01-preview`,
		func(req *http.Request) (*http.Response, error) {
			return httpmock.NewStringResponse(http.StatusOK, httpmock.File("tests/datasource/environment_application_packages/Validate_No_Dataverse/get_applications.json").String()), nil
		})
	...
	httpmock.RegisterResponder("GET", "https://europe.api.bap.microsoft.com/providers/Microsoft.BusinessAppPlatform/lifecycleOperations/00000000-0000-0000-0000-000000000001?api-version=2023-06-01",
		func(req *http.Request) (*http.Response, error) {
			return httpmock.NewStringResponse(http.StatusOK, httpmock.File("tests/datasource/environment_application_packages/Validate_No_Dataverse/get_lifecycle_delete.json").String()), nil
		})
	...
	httpmock.RegisterResponder("GET", "https://europe.api.bap.microsoft.com/providers/Microsoft.BusinessAppPlatform/lifecycleOperations/b03e1e6d-73db-4367-90e1-2e378bf7e2fc?api-version=2023-06-01",
		func(req *http.Request) (*http.Response, error) {
			return httpmock.NewStringResponse(http.StatusOK, httpmock.File("tests/datasource/environment_application_packages/Validate_No_Dataverse/get_lifecycle.json").String()), nil
		})
