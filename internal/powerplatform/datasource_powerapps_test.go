		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestMatchResourceAttr("data.powerplatform_powerapps.all", "powerapps.0.environment_id", regexp.MustCompile(powerplatform_helpers.UrlValidStringRegex)),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.powerplatform_powerapps.all", "powerapps.0.environment_id", app1.EnvironmentName.ValueString()),
					...
					resource.TestCheckResourceAttr("data.powerplatform_powerapps.all", "powerapps.1.environment_id", app2.EnvironmentName.ValueString()),
