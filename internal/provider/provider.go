...
func (p *PowerPlatformProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		func() resource.Resource { return application.NewDataRoleAssignmentResource() },
		func() resource.Resource { return role_based_access.NewRoleAssignmentResource() },
...
func (p *PowerPlatformProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		func() datasource.DataSource { return role_based_access.NewRoleAssignmentsDataSource() },
