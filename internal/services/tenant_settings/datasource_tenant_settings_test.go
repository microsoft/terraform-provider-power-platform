		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestMatchResourceAttr("data.powerplatform_tenant_settings.settings", "enable_support_use_bing_search_solutions", regexp.MustCompile(helpers.BooleanRegex)),
					resource.TestMatchResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.product_feedback.disable_user_survey_feedback", regexp.MustCompile(helpers.BooleanRegex)),
					resource.TestMatchResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.product_feedback.disable_microsoft_follow_up", regexp.MustCompile(helpers.BooleanRegex)),
					resource.TestMatchResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.product_feedback.disable_attachments", regexp.MustCompile(helpers.BooleanRegex)),
					resource.TestMatchResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.product_feedback.disable_microsoft_surveys_send", regexp.MustCompile(helpers.BooleanRegex)),
					...
					resource.TestMatchResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.governance.weekly_digest_email_recipients.#", regexp.MustCompile(`^[0-9]+$`)),
					...
					resource.TestMatchResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.intelligence.disable_basic_copilot_feedback", regexp.MustCompile(helpers.BooleanRegex)),
					resource.TestMatchResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.intelligence.disable_additional_copilot_feedback", regexp.MustCompile(helpers.BooleanRegex)),
					...
					resource.TestMatchResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.licensing.apply_auto_claim_power_apps_to_only_managed_environments", regexp.MustCompile(helpers.BooleanRegex)),
					resource.TestMatchResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.licensing.apply_auto_claim_power_automate_to_only_managed_environments", regexp.MustCompile(helpers.BooleanRegex)),
					...
					resource.TestMatchResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.power_apps.disable_copilot", regexp.MustCompile(helpers.BooleanRegex)),
					...
					resource.TestMatchResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.power_automate.disable_copilot_help_assistance", regexp.MustCompile(helpers.BooleanRegex)),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.powerplatform_tenant_settings.settings", "enable_support_use_bing_search_solutions", "false"),
					resource.TestCheckResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.product_feedback.disable_user_survey_feedback", "false"),
					resource.TestCheckResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.product_feedback.disable_microsoft_follow_up", "false"),
					resource.TestCheckResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.product_feedback.disable_attachments", "false"),
					resource.TestCheckResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.product_feedback.disable_microsoft_surveys_send", "false"),
					...
					resource.TestCheckResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.governance.weekly_digest_email_recipients.#", "2"),
					resource.TestCheckResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.governance.weekly_digest_email_recipients.0", "test1@test.com"),
					resource.TestCheckResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.governance.weekly_digest_email_recipients.1", "test2@test.com"),
					...
					resource.TestCheckResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.intelligence.disable_basic_copilot_feedback", "false"),
					resource.TestCheckResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.intelligence.disable_additional_copilot_feedback", "false"),
					...
					resource.TestCheckResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.licensing.apply_auto_claim_power_apps_to_only_managed_environments", "false"),
					resource.TestCheckResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.licensing.apply_auto_claim_power_automate_to_only_managed_environments", "false"),
					...
					resource.TestCheckResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.power_apps.disable_copilot", "false"),
					...
					resource.TestCheckResourceAttr("data.powerplatform_tenant_settings.settings", "power_platform.power_automate.disable_copilot_help_assistance", "false"),
