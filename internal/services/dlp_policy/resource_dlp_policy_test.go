		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs("powerplatform_data_loss_prevention_policy.my_policy", "non_business_connectors.*", map[string]string{
					...
					resource.TestCheckResourceAttr("powerplatform_data_loss_prevention_policy.my_policy", "custom_connectors_patterns.#", "2"),
					resource.TestCheckTypeSetElemNestedAttrs("powerplatform_data_loss_prevention_policy.my_policy", "custom_connectors_patterns.*", map[string]string{
						"order":            "1",
						"host_url_pattern": "https://*.contoso.com",
						"data_group":       "Blocked",
					}),
