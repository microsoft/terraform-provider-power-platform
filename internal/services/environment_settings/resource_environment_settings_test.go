		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("powerplatform_environment_settings.settings", "product.features.ai_form_fill_automatic_suggestions", "Default"),
					resource.TestCheckResourceAttr("powerplatform_environment_settings.settings", "product.features.ai_form_fill_smart_paste_and_file_suggestions", "Default"),
					resource.TestCheckResourceAttr("powerplatform_environment_settings.settings", "product.features.ai_form_fill_toolbar", "Default"),
					resource.TestCheckResourceAttr("powerplatform_environment_settings.settings", "product.features.natural_language_grid_and_view_search", "UserAsFeatureBecomesAvailable"),
					resource.TestCheckResourceAttr("powerplatform_environment_settings.settings", "product.features.allow_ai_to_generate_charts", "Auto"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				resource "powerplatform_environment_settings" "settings" {
					...
					email = {
					  ...
					  privacy_and_security = {
						blocked_attachment_extensions = toset(["exe", "js"])
					  }
					  product = {
						behavior_settings = {
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("powerplatform_environment_settings.settings", "privacy_and_security.blocked_attachment_extensions.#", "2"),
...
func TestUnitTestEnvironmentSettingsResource_Validate_Read(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", `https://00000000-0000-0000-0000-000000000001.crm4.dynamics.com/api/data/v9.0/RetrieveSettingList()`,
		func(req *http.Request) (*http.Response, error) {
			return httpmock.NewStringResponse(http.StatusOK, httpmock.File("tests/resources/Validate_Read/get_retrievesettinglist.json").String()), nil
		})
...
func TestUnitTestEnvironmentSettingsResource_Validate_Update(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
	...
	httpmock.RegisterResponder("GET", `https://api.bap.microsoft.com/providers/Microsoft.BusinessAppPlatform/scopes/admin/environments/00000000-0000-0000-0000-000000000001?api-version=2023-06-01`,
		func(req *http.Request) (*http.Response, error) {
			return httpmock.NewStringResponse(http.StatusOK, httpmock.File("tests/resources/Validate_Update/get_environment_00000000-0000-0000-0000-000000000001.json").String()), nil
		})

	httpmock.RegisterResponder("GET", `https://00000000-0000-0000-0000-000000000001.crm4.dynamics.com/api/data/v9.0/organizations`,
		func(req *http.Request) (*http.Response, error) {
			getOrgInx++
			return httpmock.NewStringResponse(http.StatusOK, httpmock.File(fmt.Sprintf("tests/resources/Validate_Update/get_organisations_%d.json", getOrgInx)).String()), nil
		})
	...
	httpmock.RegisterResponder("GET", `https://00000000-0000-0000-0000-000000000001.crm4.dynamics.com/api/data/v9.0/RetrieveSettingList\(\)?`,
		func(req *http.Request) (*http.Response, error) {
			var file string
			if testStep == 1 {
				file = "tests/resources/Validate_Update/get_retrievesettinglist_step1.json"
			} else {
				file = "tests/resources/Validate_Update/get_retrievesettinglist_step2.json"
			}
