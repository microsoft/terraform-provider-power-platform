...
page_title: "powerplatform_environment Resource - Power Platform"
subcategory: ""
description: |-
  ...
  Environments overview - Power Platform | Microsoft Learn https://learn.microsoft.com/power-platform/admin/environments-overviewCreate and manage environments in the Power Platform admin center https://learn.microsoft.com/power-platform/admin/create-environmentEstablishing an environment strategy - Microsoft Power Platform https://learn.microsoft.com/power-platform/guidance/adoption/environment-strategy
---
...
- `allow_moving_data_across_regions` (Boolean) Allow moving data across regions. When `macro_region` is used, the location specific constraints on this setting are enforced by the service rather than by this provider, because the datacenter location is not known until the environment is created.
