...
page_title: "powerplatform_environment_role_based_access_assignments Data Source - Power Platform"
subcategory: ""
description: |-
  Fetches the role assignments https://learn.microsoft.com/en-us/rest/api/power-platform/authorization/role-based-access-control/list-environment-role-assignments scoped to a given environment in Power Platform. Use this data source to discover which principals are assigned roles on an environment.
---

# powerplatform_environment_role_based_access_assignments (Data Source)
...
- `role_assignments` (Attributes List) List of role assignments scoped to the environment (see [below for nested schema](#nestedatt--role_assignments))
