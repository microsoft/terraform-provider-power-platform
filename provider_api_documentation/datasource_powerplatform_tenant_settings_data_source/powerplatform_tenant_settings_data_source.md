...
This data source is used to read tenant-wide settings in Power Platform.
...
An example of the API response used by this data source can be found in the test fixture [`tenant_settings/tests/datasource/post_list_tenant_settings.json`](https://github.com/microsoft/terraform-provider-power-platform/blob/main/internal/services/tenant_settings/tests/datasource/post_list_tenant_settings.json).
