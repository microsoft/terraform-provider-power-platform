...
* [#116](https://github.com/microsoft/terraform-provider-power-platform/issues/116) `powerplatform_managed_environment` adding `solution_checker_rule_overrides` attribute that allows defining solutin checker rules when enabling managed environment
...
* [#572](https://github.com/microsoft/terraform-provider-power-platform/issues/572) `powerplatform_environment` support get new features early wiht new `release_cycle` attribute
