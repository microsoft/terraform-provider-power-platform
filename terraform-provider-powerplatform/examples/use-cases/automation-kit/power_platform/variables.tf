...
variable "key_vault_secret_client_id_name" {
}

variable "key_vault_secret_client_password_name" {
}

variable "key_vault_client_secret_tenant_id_name" {
}
...
variable "automation_kit_application_id" {
}
